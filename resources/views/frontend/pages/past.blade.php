    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix" ng-controller="EventsController">
            ...
            <div id="posts" class="events small-thumbs">
                ...
                <div class="entry clearfix" ng-repeat="event in events |  eventDateFilterPast:'start_datetime' | orderBy:'start_datetime':true" >
                <!--<div class="entry clearfix" ng-repeat="event in events" >-->
                    <div class="entry-image">
                        <a href="[[event.cover[2].filename]]">
                    ...
                    <div class="entry-c">
                        ...
                        <ul class="entry-meta clearfix">
                            ...
                            <li><a href="[[event.url]]"><i class="icon-time"></i> [[event.start_datetime | date: 'shortTime' ]]</a></li>
                            <li><a href="[[event.url]]"><i class="icon-map-marker2"></i> [[event.city]]</a></li>
                        </ul>
